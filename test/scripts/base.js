define("dist/js/app", ["./zepto", "./touch", "./global", "./page", "./media", "./image", "./event", "./sileFn", "./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./weixin", "./Lottery", "./video"], function (require, exports, module) {
    var $ = require("./zepto");
    $ = require("./touch");
    var global = require("./global"), page = require("./page"), media = require("./media");
    require("./image"), require("./event"), require("./plugins"), module.exports = {init_modle: function () {
    ...
    var i = function () {
        ...
        var w, _, C, k, j, T, S = [], E = S.slice, z = S.filter, N = window.document, P = {}, $ = {}, M = {"column-count": 1, columns: 1, "font-weight": 1, "line-height": 1, opacity: 1, "z-index": 1, zoom: 1}, A = /^\s*<(\w+|!)[^>]*>/, O = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, q = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, D = /^(?:body|html)$/i, L = /([A-Z])/g, I = ["val", "css", "html", "text", "data", "width", "height", "offset"], F = ["after", "prepend", "before", "append"], B = N.createElement("table"), R = N.createElement("tr"), H = {tr: N.createElement("tbody"), tbody: B, thead: B, tfoot: B, td: R, th: R, "*": N.createElement("div")}, W = /complete|loaded|interactive/, Z = /^[\w-]*$/, Y = {}, U = Y.toString, V = {}, J = N.createElement("div"), X = {tabindex: "tabIndex", readonly: "readOnly", "for": "htmlFor", "class": "className", maxlength: "maxLength", cellspacing: "cellSpacing", cellpadding: "cellPadding", rowspan: "rowSpan", colspan: "colSpan", usemap: "useMap", frameborder: "frameBorder", contenteditable: "contentEditable"}, G = Array.isArray || function (t) {
        ...
        return V.matches = function (t, e) {
            ...
            var i;
            if (!t)return V.Z();
            if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && A.test(t))i = V.fragment(t, RegExp.$1, n), t = null; else {
                if (n !== w)return C(n).find(t);
                i = V.qsa(N, t)
            } else {
                if (e(t))return C(N).ready(t);
                if (V.isZ(t))return t;
                if (G(t))i = s(t); else if (a(t))i = [t], t = null; else if (A.test(t))i = V.fragment(t.trim(), RegExp.$1, n), t = null; else {
                    if (n !== w)return C(n).find(t);
                    i = V.qsa(N, t)
                }
            }
            ...
            var n, i, a, o = [];
            if (r(t))for (i = 0; t.length > i; i++)n = e(t[i], i), null != n && o.push(n); else for (a in t)n = e(t[a], a), null != n && o.push(n);
            return l(o)
        }, C.each = function (t, e) {
            var n, i;
            if (r(t)) {
        ...
        }), C.fn = {forEach: S.forEach, reduce: S.reduce, push: S.push, sort: S.sort, indexOf: S.indexOf, concat: S.concat, map: function (t) {
            ...
            var n = e(t);
            if (this[0] && !n)var i = C(t).get(0), a = i.parentNode || this.length > 1;
            ...
            return"string" == typeof t && e === w ? 0 == this.length || 1 !== this[0].nodeType ? w : "value" == t && "INPUT" == this[0].nodeName ? this.val() : !(n = this[0].getAttribute(t)) && t in this[0] ? this[0][t] : n : this.each(function (n) {
                if (1 === this.nodeType)if (a(t))for (_ in t)v(this, _, t[_]); else v(this, t, m(this, e, n, this.getAttribute(t)))
            })
            ...
            if (t)return this.each(function (e) {
                var n = C(this), i = m(this, t, e, n.offset()), a = n.offsetParent().offset(), o = {top: i.top - a.top, left: i.left - a.left};
            ...
            if (this.length) {
                var t = this[0], e = this.offsetParent(), n = this.offset(), i = D.test(e[0].nodeName) ? {top: 0, left: 0} : e.offset();
            ...
            C.fn[e] = function () {
                ...
                return 1 > o.length ? this : this.each(function (t, e) {
                    a = i ? e : e.parentNode, e = 0 == n ? e.nextSibling : 1 == n ? e.firstChild : 2 == n ? e : null, o.forEach(function (t) {
                        if (r)t = t.cloneNode(!0); else if (!a)return C(t).remove();
    ...
    window.Zepto = i, void 0 === window.$ && (window.$ = i), function (t) {
        ...
        }, m = {}, v = {}, x = "onfocusin"in window, b = {focus: "focusin", blur: "focusout"}, y = {mouseenter: "mouseover", mouseleave: "mouseout"};
        v.click = v.mousedown = v.mouseup = v.mousemove = "MouseEvents", t.event = {add: s, remove: l}, t.proxy = function (n, i) {
            if (p(n)) {
                var a = function () {
        ...
        var w = function () {
            ...
            return!1
        }, C = /^([A-Z]|returnValue$|layer[XY]$)/, k = {preventDefault: "isDefaultPrevented", stopImmediatePropagation: "isImmediatePropagationStopped", stopPropagation: "isPropagationStopped"};
        t.fn.delegate = function (t, e, n) {
            ...
            return e && !g(e) ? (t.each(e, function (t, e) {
                ...
                o && (r = function (t) {
                    ...
                    return o && o !== h ? (i = t.extend(u(e), {currentTarget: o, liveFired: h}), (r || a).apply(o, [i].concat(f.call(arguments, 1)))) : void 0
                }), s(h, e, a, i, n, c || r)
            }))
        ...
        function f(e, n, i, a) {
            return t.isFunction(n) && (a = i, i = n, n = void 0), t.isFunction(i) || (a = i, i = void 0), {url: e, data: n, success: i, dataType: a}
        }
        ...
        var g, m, v = 0, x = window.document, b = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, y = /^(?:text|application)\/javascript/i, w = /^(?:text|application)\/xml/i, _ = "application/json", C = "text/html", k = /^\s*$/;
        t.active = 0, t.ajaxJSONP = function (e, n) {
            if (!("type"in e))return t.ajax(e);
            var i, a, l = e.jsonpCallback, c = (t.isFunction(l) ? l() : l) || "jsonp" + ++v, u = x.createElement("script"), d = window[c], h = function (e) {
        ...
        }, accepts: {script: "text/javascript, application/javascript, application/x-javascript", json: _, xml: "application/xml, text/xml", html: C, text: "text/plain"}, crossDomain: !1, timeout: 0, processData: !0, cache: !0}, t.ajax = function (e) {
            ...
            var p, v = n.accepts[l], x = {}, b = function (t, e) {
                x[t.toLowerCase()] = [t, e]
            }, y = /^([\w-]+:)\/\//.test(n.url) ? RegExp.$1 : window.location.protocol, w = n.xhr(), _ = w.setRequestHeader;
    ...
    var e = t("./zepto"), n = function (t) {
        ...
        var n = e(t.currentTarget), i = n.attr("data-action") || "", a = /^([a-zA-Z0-9_]+):\/\/([a-zA-Z0-9_]+)$/, o = a.exec(i), r = null, s = null, l = {node: n, e_node: t, _node: t.currentTarget};
        o && (r = o[1], s = o[2], r in e && s in e[r] && e[r][s].call(null, l))
    }, i = {_click: "ontouchstart"in window ? "tap" : "click", _events: {}, _windowHeight: e(window).height(), _windowWidth: e(window).width(), _rotateNode: e(".p-ct"), _isMotion: !!window.DeviceMotionEvent, _elementStyle: document.createElement("div").style, _UC: RegExp("Android").test(navigator.userAgent) && RegExp("UC").test(navigator.userAgent) ? !0 : !1, _weixin: RegExp("MicroMessenger").test(navigator.userAgent) ? !0 : !1, _iPhoen: RegExp("iPhone").test(navigator.userAgent) || RegExp("iPod").test(navigator.userAgent) || RegExp("iPad").test(navigator.userAgent) ? !0 : !1, _Android: RegExp("Android").test(navigator.userAgent) ? !0 : !1, _IsPC: function () {
        ...
        var a, o, r, s, l = document.createElement("div"), c = document.body, u = c || document.createElement("body"), d = "modernizr";
        if (parseInt(n, 10))for (; n--;)r = document.createElement("div"), r.id = i ? i[n] : d + (n + 1), l.appendChild(r);
    ...
    var e = t("./zepto"), n = t("./global"), i = {_page: e(".m-page"), _pageNum: e(".m-page").size(), _pageNow: 0, _pageNext: null, _touchStartValY: 0, _touchDeltaY: 0, _moveStart: !0, _movePosition: null, _movePosition_c: null, _mouseDown: !1, _moveFirst: !0, _moveInit: !1, _firstChange: !1, page_start: function () {
        ...
        if (t.preventDefault(), i._moveStart && i._moveInit) {
            ...
            if ("touchmove" == t.type)e = window.event.touches[0].pageY, r = !0; else {
        ...
        var s, l;
        if ("undefined" != a && (i._touchDeltaY = a - i._touchStartValY), i._movePosition = a - i._touchStartValY > 0 ? "down" : "up", i._movePosition != i._movePosition_c ? (i._moveFirst = !0, i._movePosition_c = i._movePosition) : i._moveFirst = !1, 0 >= i._touchDeltaY)i._pageNext = 0 == o.next(".m-page").length ? 0 : i._pageNow + 1, l = i._page.eq(i._pageNext)[0]; else {
    ...
    var e = t("./zepto"), n = t("./global"), i = {_audioNode: e(".u-audio"), _audio: null, audio_init: function () {
        if (!(0 >= i._audioNode.length)) {
            var t = {loop: !0, preload: "auto", src: this._audioNode.attr("data-src")};
        ...
        if (!(0 >= this._audioNode.length)) {
            var i = this._audioNode.find(".txt_audio"), a = null;
    ...
    var e = t("./zepto"), n = t("./page"), i = {lazy_img: function () {
        var t = e(".lazy-img");
        t.each(function () {
            var t = e(this);
            if (t.is("img"))t.attr("src", "/template/20/res/img/loading_large.gif"); else {
                var n = t.css("background-position"), i = t.css("background-size");
                t.attr({"data-position": n, "data-size": i}), "no" == t.attr("data-bg") && t.css({"background-repeat": "no-repeat"}), t.css({"background-image": "url(/template/20/res/img/loading_large.gif)", "background-size": "120px 120px", "background-position": "center"}), "no" == t.attr("data-image") && t.css({"background-image": "none"})
            }
        })
    }, lazy_start: function () {
        var t = this;
        ...
        o.each(function () {
            ...
            "no" != t.attr("data-bg") ? (e("<img />").on("load", function () {
                if (t.is("img") ? t.attr("src", a) : t.css({"background-image": "url(" + a + ")", "background-position": o, "background-size": r}), n)for (var s = 0; e(".m-page").size() > s; s++) {
                    var l = e(".m-page").eq(s);
        ...
        t.each(function () {
            ...
            "no" != t.attr("data-bg") ? (e("<img />").on("load", function () {
                t.is("img") ? t.attr("src", n) : t.css({"background-image": "url(" + n + ")", "background-position": i, "background-size": a})
    ...
    var e = t("./zepto"), n = t("./global"), i = t("./page"), a = t("./image"), o = t("./sileFn"), r = t("./media");
    ...
    var e = t("./zepto"), n = t("./global"), i = t("./page"), a = t("./map"), o = t("./form"), r = {mapCreate: function () {
        if (!(0 >= ".j-map".length)) {
            var t = e(".j-map"), i = {fnOpen: n._scrollStop, fnClose: a.mapSave};
    ...
    var $ = require("./zepto");
    $ = require("./ylMap");
    var global = require("./global"), page = require("./page"), media = require("./media"), __map = {_map: $(".ylmap"), _mapValue: null, _mapIndex: null, mapAddEventHandler: function (t, e, n, i) {
        var a = n;
        ...
        global._scrollStop(), __map._map.addClass("show"), $(document.body).animate({scrollTop: 0}, 0), $(this).attr("data-mapIndex") != __map._mapIndex ? (__map._map.html($('<div class="bk"><span class="css_sprite01 s-bg-map-logo"></span></div>')), __map._mapValue = !1, __map._mapIndex = $(this).attr("data-mapIndex")) : __map._mapValue = !0, setTimeout(function () {
        ...
        var t = t, e = Number(e), n = Number(n), i = "function" == typeof i ? i : "", a = "function" == typeof a ? a : "", o = {sign_name: "", contact_tel: "", address: "天安门"};
        t = global._isOwnEmpty(t) ? o : t, e = e ? e : 39.915, n = n ? n : 116.404, __map._map.ylmap({detal: t, latitude: e, longitude: n, fnOpen: i, fnClose: a})
    }};
    return __map
    ...
    n.exports = i, function (t) {
        t.fn.ylmap = function (e) {
            t.fn.ylmap.defaults = {detal: {sign_name: "TXjiang", contact_tel: 18624443174, address: "天安门"}, latitude: 39.915, longitude: 116.404, fnOpen: null, fnClose: null};
            ...
            return this.each(function () {
                ...
                var a, o, r, s, l = t(this), c = n.detal, u = n.latitude, d = n.longitude, h = n.fnClose, f = (n.fnOpen, l.hasClass("bigOpen")), p = null, g = null, m = null, v = null, x = t('<div id="BDMap" class="BDMap"></div>');
                ...
                var b = function () {
                    ...
                    var a = {width: 0, height: 0, title: " "}, r = new BMap.InfoWindow(i[0], a);
                ...
                open_navigate = function (e) {
                    ...
                    e.appendTo(l), g = new BMap.TransitRoute(o, {renderOptions: {map: o, panel: "transit_result", autoViewport: !0}, onSearchComplete: searchComplete}), g.search(v, r)
                }, self_transit = function () {
                    if (g && g.clearResults(), m && m.clearResults(), !v)return alert("抱歉：定位失败！"), void 0;
                    t(".fn-audio").hide(), "function" == typeof loadingPageShow && loadingPageShow(), t(".infoWindow").find("span.State").html("正在绘制出导航路线");
                    var e = t("#transit_result") || t('<div id="transit_result"></div>');
                    e.appendTo(l), m = new BMap.DrivingRoute(o, {renderOptions: {map: o, panel: e.attr("id"), autoViewport: !0}, onSearchComplete: searchComplete}), m.search(v, r)
    ...
    var e = t("./zepto"), n = t("./global"), i = t("./page"), a = {signUpCheck_input: function (t, n) {
        var i = !0, o = t.find("input");
        return o.each(function () {
            if ("" != this.name && "undefined" != this.name) {
                var t = this.name, o = e(this).attr("placeHolder"), r = a.regFunction(t, o), s = r.empty_tip, l = r.reg, c = r.reg_tip;
        ...
        return{empty_tip: i, reg_tip: a, reg: o}
    }, signUpCheck_submit: function (t, o) {
        n.loadingPageShow(e(".u-pageLoading"));
        var r = "/auto/submit/" + e("#activity_id").val();
        e.ajax({url: r, cache: !1, dataType: "json", async: !0, type: "POST", data: t.serialize(), success: function (t) {
    ...
    var n = t("./Lottery"), i = t("./global"), a = t("./page"), o = t("./media"), r = t("./video"), s = {init: function () {
        e("#coffee_flow").coffee({steams: ["<img src='/template/19/img/audio_widget_01@2x.png' />", "<img src='/template/19/img/audio_widget_01@2x.png' />"], steamHeight: 100, steamWidth: 44}), o.media_init(), r.video_init();
        var t = {};
        ...
        if (1 == n) {
            var a = e("#j-mengban")[0], l = "/template/19/img/page_01_bg@2x.jpg", c = e("#r-cover").val(), u = "image", d = 640, h = e(window).height(), f = s.start_callback;
    ...
    a = t("./fx"), n.exports = a, function (t) {
        t.fn.coffee = function (e) {
            function n() {
                var e = r(8, h.steamMaxSize), n = o(1, h.steamsFontFamily), i = "#" + o(6, "0123456789ABCDEF"), a = r(0, 44), l = r(-90, 89), c = s(.4, 1), d = t.fx.cssPrefix + "transform";
                d = d + ":rotate(" + l + "deg) scale(" + c + ");";
                var g = t('<span class="coffee-steam">' + o(1, h.steams) + "</span>"), m = r(0, f - h.steamWidth - e);
            ...
            var l = null, c = null, u = "cubic-bezier(.09,.64,.16,.94)", d = t(this), h = t.extend({}, t.fn.coffee.defaults, e), f = h.steamWidth, p = t('<div class="coffee-steam-box"></div>').css({height: h.steamHeight, width: h.steamWidth, left: 60, top: -50, position: "absolute", overflow: "hidden", "z-index": 0}).appendTo(d);
    ...
    n.exports = i, function (t, e) {
        ...
        t.each(g, function (t, n) {
            ...
            var v, y, w, _ = {}, C = "", k = this, j = t.fx.transitionEnd, T = !1;
            if (a === e && (a = t.fx.speeds._default / 1e3), m === e && (m = 0), t.fx.off && (a = 0), "string" == typeof i)_[u] = i, _[d] = a + "s", _[f] = m + "s", _[h] = p || "linear", j = t.fx.animationEnd; else {
                y = [];
...
}), define("dist/js/weixin", ["./zepto"], function (e, n, i) {
    var a = e("./zepto");
    i.exports = a, function (e) {
        e.fn.wx = function (n) {
            function i(t, e) {
                var n = 2e3;
                e = e || 0, !0 === window.G_WEIXIN_READY || "WeixinJSBridge"in window ? t.apply(null, []) : n >= e && setTimeout(function () {
                    i(t, e++)
                }, 15)
            }
            ...
            function o() {
                var e = a("uid"), n = "", i = "";
                e && (t = e.split("~"), u.uid = t[1], n = u.uid), e = a("openid"), e && (t = e.split("~"), u.openid = t[1], i = u.openid);
                var o = "";
                if (n) {
                    var r = document.location.href;
                    if (s = r.match(/openid=([^&]*)/)) {
                        o = s[1];
                        var r = r.replace(/openid=([^&]*)/, "openid=" + o + "," + n);
                        u.link = r
                    } else {
                        var r = r + "&openid=" + n;
                        u.link = r
            ...
            function r(t) {
                var e = document.createElement("script");
                e.src = t, e.type = "text/javascript", document.getElementsByTagName("body")[0].appendChild(e)
            }

            function l(t, e, n, i, a) {
                var o = new String(document.domain);
                domain = "cgtest.lightapp.cn" != o && "tt.lightapp.cn" != o && "t.lightapp.cn" != o && "dev.liveapp.cn" != o && o.match(/www.lightapp.cn/i) && o.match(/www.liveapp.cn/i) ? "bi.lightapp.cn" : "bitest.lightapp.cn";
                var s = "http://" + domain + "/api/welcome/share_app?activity_id=" + t + "&activity_name=" + e + "&link=" + encodeURIComponent(n) + "&type=" + i + "&open_id=" + a;
                r(s)
            }

            var c = e(this);
            e.fn.wx.defaults = {title: "云来轻APP-创新作品1号，仅限内测体验", con: "创新1号仅限内部小伙伴们尽情体验！！", link: document.URL, img: location.protocol + "//" + location.hostname + ":" + location.port + "/template/19/img/wx_img_01@2x.jpg?time=1"};
            var u = e.extend({}, e.fn.wx.defaults, n);
            document.addEventListener("WeixinJSBridgeReady", function () {
                window.G_WEIXIN_READY = !0
            }, !1);
            var d = {execHandler: function (t) {
                if (t && t instanceof Object) {
                ...
                this.execHandler(t)
            }}, h = {Share: {weibo: function (t, e) {
                i(function () {
                    WeixinJSBridge.on("menu:share:weibo", function () {
                        WeixinJSBridge.invoke("shareWeibo", t, function (t) {
                            d.execAfterMergerHandler(e, [t])
                        })
                    })
                })
                ...
                i(function () {
                    !0 === t ? WeixinJSBridge.call("showToolbar") : WeixinJSBridge.call("hideToolbar"), d.execAfterMergerHandler(e, [t])
                })
            }, setOptionMenu: function (t, e) {
                i(function () {
                    !0 === t ? WeixinJSBridge.call("showOptionMenu") : WeixinJSBridge.call("hideOptionMenu"), d.execAfterMergerHandler(e, [t])
                })
            }, pay: function (t, e) {
                i(function () {
                    var n = {appId: "", timeStamp: "", nonceStr: "", "package": "", signType: "", paySign: ""}, i = e || {}, a = null, o = [t];
                    for (var r in n)n.hasOwnProperty(r) && (n[r] = t[r] || "", console.info(r + " = " + n[r]));
                    WeixinJSBridge.invoke("getBrandWCPayRequest", n, function (t) {
                        ...
                        d.execAfterMergerHandler(a, o)
                    })
                })
            }};
            o();
            var f = {content: u.con}, p = {img_url: u.img, img_width: 180, img_height: 180, link: u.link, desc: u.con, title: u.title};
            return handler = {callback: function () {
                var t = 0, e = "", n = "", i = u.title, a = u.link, o = u.openid;
                (e = a.match(/index\/(\d+)/)) && (t = parseInt(e[1]));
                var r = "";
                (e = a.match(/from=(\w+)/)) && (r = e[1], "timeline" == r ? n = "timeline" : "singlemessage" == r ? n = "singlemessage" : "groupmessage" == r && (n = "groupmessage")), l(t, i, a, n, o)
            }}, window.stat_succ = function () {
                u.callback && (window.location.href = u.callback)
            }, h.Share.timeline(p, handler), h.Share.message(p, handler), h.Share.weibo(f, handler), c
        }, e.fn.wx.version = "1.2.3"
    }(a)
    ...
    var a = t("./zepto");
    i.prototype = {createElement: function (t, e) {
    ...
    var e = t("./zepto"), n = t("./global"), i = {_video: e(".j-video"), _videoArr: [], video_init: function () {
        var t = this;
        this._video.each(function () {
            var i, a = e(this).attr("data-video-src"), o = e(this).attr("data-video-type"), r = e(this).find(".img"), s = e(this).find(".video");
        ...
        var n = {controls: "controls", preload: "none", src: t}, i = e("<video></video>")[0];
