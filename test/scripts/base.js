(function(a){
    function Lottery(el, opts) {
        ...
        this.beforeCallback = opts.beforeCallback || null;
    ...
    Lottery.prototype = {
        createElement: function(t, e) {
            ...
            this.maskCtx.beginPath(),
                ...
                this.mask.style.zIndex = 9999999 == this.mask.style.zIndex ? 9999999 :99999999;
        },bindEvent: function() {
            ...
            if ("image" == this.lotteryType) {
                ...
                t.onload = function() {
                    ...
                    if (e.fillImage){
                        ...
                        e.backCtx.drawImage(this, e.marginLeft, e.marginTop, e.width, e.height);
                    }
                    e.drawMask();
                }, t.src = this.lottery
            ...
            if ("color" == this.coverType)
                ...
                t.onload = function() {
                    ...
                    //e.maskCtx.drawImage(this, e.marginLeft, e.marginTop, this.width, this.height, 0, 0, e.width, e.height);
