...
!function (a) {
  function b() {
    ...
    var b = [
      {value: 1, desc: "轮播", name: "slide"},
      {value: 2, desc: "下落", name: "bars"},
      {value: 3, desc: "百页窗", name: "blinds"},
      {value: 4, desc: "消隐", name: "blocks"},
      {value: 5, desc: "渐变", name: "blocks2"},
      {value: 9, desc: "梳理", name: "zip"},
      {value: 11, desc: "翻转", name: "bars3d"},
      {value: 13, desc: "立方体", name: "cube"},
      {value: 14, desc: "棋盘", name: "tiles3d"},
  ...
  var i = a.templateParser("jsonParser", function () {
    ...
    function b(a, b) {
      ...
      if (c) {
        ...
        if (a.css) {
          ...
          if (e.css({width: g}), e.css({width: a.css.width, height: a.css.height, left: a.css.left, top: a.css.top, zIndex: a.css.zIndex, bottom: a.css.bottom, transform: a.css.transform}), "edit" != i.mode && "x" == ("" + a.type).charAt(0))return e.append(c), e.find(".element-box").css({borderStyle: a.css.borderStyle, borderWidth: a.css.borderWidth, borderColor: a.css.borderColor, borderTopLeftRadius: a.css.borderTopLeftRadius, borderTopRightRadius: a.css.borderTopRightRadius, borderBottomRightRadius: a.css.borderBottomRightRadius, borderBottomLeftRadius: a.css.borderBottomLeftRadius, boxShadow: a.css.boxShadow, backgroundColor: a.css.backgroundColor, opacity: a.css.opacity, width: "100%", height: "100%", overflow: "hidden"}), e.find("img").css({width: "100%"}), e;
          isAndroid() && isWeixin() && 4 == a.type && "0px" != a.css.borderRadius && 0 == a.css.borderWidth && a.properties.anim && (a.css.borderWidth = 1, a.css.borderColor = "rgba(0,0,0,0)"), f.css(a.css).css({width: "100%", height: "100%", transform: "none"}), f.children(".element-box-contents").css({width: "100%", height: "100%"}), 4 != ("" + a.type).charAt(0) && "n" != ("" + a.type).charAt(0) && "p" != ("" + a.type).charAt(0) && "h" != ("" + a.type).charAt(0) && $(c).css({width: a.css.width, height: a.css.height}), "h" == ("" + a.type).charAt(0) && ($(c).find("g").length ? $(c).find("g").attr("fill", a.css.color) : $(c).children().attr("fill", a.css.color))
        }
        return e
      }
    }
    ...
    var l = {}, m = {}, n = {}, o = [], p = containerWidth = 320, q = containerHeight = 486, r = 1, s = 1, t = {getComponents: f, getEventHandlers: e, addComponent: a(l), bindEditEvent: a(m), bindAfterRenderEvent: a(n), addInterceptor: j, getInterceptors: k, wrapComp: b, mode: "view", parse: function (a) {
  ...
  i.addInterceptor(function (a, b, c) {
    ...
    var b;
    if ("edit" == i.mode)b = document.createElement("div"), b.id = a.id, b.setAttribute("ctype", a.type), b.setAttribute("class", "element comp_paragraph editable-text"), a.content && (b.innerHTML = a.content), b.style.cursor = "default"; else var b = '<div class="element-box"><img src="' + a.properties.dataUrl + '"></div>';
    return b
  }), i.addComponent("3", function (a) {
    var b, c = document.createElement("div");
    "edit" == i.mode ? (b = $("#nr .edit_wrapper"), c.setAttribute("class", "wrapper-background"), c.setAttribute("id", a.id)) : "view" == i.mode && (b = $("#edit_area" + i.def.id).parent(".edit_wrapper"), c.setAttribute("id", "wrapper-background" + i.def.id)), $(c).prependTo(b).css({width: "100%", height: "100%"});
    var d, e = new Image;
    ...
    if (d.append(e), "view" == i.mode ? a.counterValues && a.counterValues.then(function (c) {
      var d = c.map[b.id] || 0, f = a.fixedNum(d);
      e.text(f)
    ...
    if (a = $("button", a)[0], "view" == i.mode) {
      var c;
      c = /zh/.test(eqxCommon.getFirstBrowserLanguage()) ? {REQUIRED: "为必填项！", WRONG_PHONE_NUMBER_FORMAT: "手机号码格式错误！", WRONG_EMAIL_FORMAT: "邮箱格式错误！", FILL_OUT_THE_FORM: "请填写表单！", DUPLICATED_SUBMISSION: "请不要重复提交！", THANKS_FOR_PARTICIPATION: "谢谢您的参与！"} : {REQUIRED: " is required!", WRONG_PHONE_NUMBER_FORMAT: "Wrong format of phone number!", WRONG_EMAIL_FORMAT: "Wrong format of email!", FILL_OUT_THE_FORM: "Please fill out the form!", DUPLICATED_SUBMISSION: "Duplicated submission!", THANKS_FOR_PARTICIPATION: "Thanks for your participation!"};
      var d = function (a, b, d) {
        ...
        if ($("textarea", d).each(function () {
          ...
          return g ? void $.ajax({cache: !0, type: "POST", url: PREFIX_S1_URL + "eqs/r/" + b, data: $.param(f), async: !1, error: function (a) {
            alert("Connection error")
          }, success: function (b) {
...
eqShow.getShowCount = function (a) {
  return this.showCount = $.ajax({type: "GET", url: PREFIX_S1_URL + "eqs/scene/pv?sceneId=" + a, xhrFields: {withCredentials: !0}, error: function (a) {
    alert("Connection error")
  }, crossDomain: !0}), this.showCount
  ...
  if (a.obj.property.slideNumber) {
    var c = $('<div class="progress"></div>'), d = $("<span></span>"), e = $('<em class="page-tip"></em>');
    c.append(d).append(e), $("#nr").append(c.css("display", "block"))
  }
  var f = function () {
    a.obj.property.slideNumber && d && setTimeout(function () {
      var a = $(".z-active").get(0) ? $(".z-active").get(0) : $(".z-current").get(0), f = $(a).find(".m-img").attr("id").substring(4), g = b.length, h = f / g, i = 100;
  ...
  window.eqx = {}, window.eqx.money = {config: {mode: 3, effectCallback: "editMoney", imageCallback: "countMoney", resources: [
    {url: CLIENT_CDN + "view/js/countMoney.js", type: "js"},
    {url: CLIENT_CDN + "assets/images/money/moneybg.png", type: "image"},
    {url: CLIENT_CDN + "assets/images/money/moremoney.png", type: "image"},
    {url: CLIENT_CDN + "assets/images/money/flymoney.png", type: "image"},
    {url: CLIENT_CDN + "assets/images/money/float.png", type: "image"},
    {url: CLIENT_CDN + "assets/images/money/float2.png", type: "image"},
    {url: CLIENT_CDN + "assets/images/money/float3.png", type: "image"}
  ]}}, window.eqx.snowFly = {config: {mode: 4, effectCallback: "flyAction", resources: [
    {url: CLIENT_CDN + "view/js/effect/snoweffect.js", type: "js"},
    {url: CLIENT_CDN + "view/js/effect/threecanvas.js", type: "js"}
  ]}}, window.eqx.rainyDay = {config: {mode: 4, effectCallback: "rainyEffect", resources: [
    {url: CLIENT_CDN + "view/js/effect/rainyday.js", type: "js"},
    {url: CLIENT_CDN + "view/js/effect/rainyeffect.js", type: "js"}
  ]}}, window.eqx.fireWorks = {config: {mode: 4, effectCallback: "fireWorks", resources: [
    {url: CLIENT_CDN + "view/js/effect/fireworks.js", type: "js"}
  ]}}
}(), function () {
  function a(a) {
  ...
  function c(a, c) {
    completeEffect(b(".z-current")) && (E = "started", D.length || (D = n.find(".main-page")), c || (B ? (a = event, q = {x: a.touches[0].pageX - n.offset().left, y: a.touches[0].pageY - n.offset().top}) : q = {x: a.pageX - n.offset().left, y: a.pageY - n.offset().top}))
  }

  function d(a, c) {
    if (E = "turning", W.obj.property.autoFlip && W.obj.property.autoFlipTime && m(), c || (B ? (a = event, r = {x: a.touches[0].pageX - n.offset().left, y: a.touches[0].pageY - n.offset().top}) : r = {x: a.pageX - n.offset().left, y: a.pageY - n.offset().top}), s = r.x - q.x, 0 > s) {
      if (x) {
        ...
        if (o = b("#flip" + d), Z || (z = b(y).parent(".flip-mask").get(0).nextElementSibling && b(b(y).parent(".flip-mask").get(0).nextElementSibling).find(".main-page").get(0) ? b(b(y).parent(".flip-mask").get(0).nextElementSibling).find(".main-page").get(0) : A ? D.first().get(0) : !1), z) {
          ...
          b(y).parent(".flip-mask").css({zIndex: 100, display: "block"}), b(z).addClass("z-active").parent(".flip-mask").css({zIndex: 99, display: "block"}), i(z), completeEffect(b(z)) || b("#audio_btn").css("opacity", 0), t ? (b(".z-current").css({top: o.height() - n.height() + "px", left: "0"}), o.css({top: "-" + (o.height() - n.height()) + "px"}), b(".turning").css({transformOrigin: "0% 100% 0px", left: n.width() + "px", top: n.height() + "px"})) : u ? b(".turning").css({top: "0", left: n.width() + "px", transformOrigin: "0% 0% 0px"}) : v && (b(".z-current").css({top: 0, left: b(this).width() - n.width() + "px"}), o.css({top: 0, left: -(o.width() - n.width()) + "px"}), b(".turning").css({transformOrigin: "0% 100% 0px", left: n.width() + "px", top: 0}))
        }
      }
    } else if (s > 0 && x) {
      ...
      o = b("#flip" + d), Z || (z = b(y).parent(".flip-mask").get(0).previousElementSibling && b(b(y).parent(".flip-mask").get(0).previousElementSibling).find(".main-page").get(0) ? b(b(y).parent(".flip-mask").get(0).previousElementSibling).find(".main-page").get(0) : A ? D.last().get(0) : !1), z && (i(z), completeEffect(b(z)) || b("#audio_btn").css("opacity", 0), b(y).parent(".flip-mask").css({
        display: "block"}), b(z).addClass("z-active").parent(".flip-mask").css({zIndex: 99, display: "block"}), b(".turning").css({top: "0", left: "0", transformOrigin: "0% 0% 0px"}))
    }
    z && f(r)
  }
  ...
  function e(a, b) {
    ...
    b ? (c = a.x, d = a.y) : B ? (c = r.x - n.offset().left, d = r.y - n.offset().top) : (c = a.pageX - n.offset().left, d = a.pageY - n.offset().top), t ? (F = 16, e = -n.width(), g = n.height(), C = setInterval(function () {
      c = F >= c - e ? c : c - F, d = F >= g - d ? d : d + F, f({x: c, y: d}), F >= c - e && F >= g - d && (clearInterval(C), h())
    }, 10)) : u ? (F = 16, e = -n.width(), g = 0, C = setInterval(function () {
      c = F >= c - e ? c : c - F, d = F >= d - g ? d : d - F, f({x: c, y: d}), F >= c - e && F >= d - g && (clearInterval(C), h())
  ...
  function f(a) {
    t || u ? (H = n.width() - a.x, t ? I = Math.abs(n.height() - a.y) : u && (I = a.y), J = I / H, K = I / Math.sqrt(H * H + I * I), L = Math.sqrt(1 - K * K), M = Math.sqrt(H * H + I * I) / 2, N = M * J, O = Math.sqrt(N * N + M * M), P = O / J, G = 180 * Math.atan(J) / Math.PI > 0 ? 180 * Math.atan(J) / Math.PI : 0, Q = (n.width() - O) * L, R = (n.width() - O) * K * L, S = (n.width() - O) * (1 - K * K), Q >= 1 && (t ? (G > 1 ? b(".turning").css({width: O + "px", height: P + "px", backgroundColor: "#ff0000", background: "-webkit-linear-gradient(" + (180 - G) + "deg, #fff 10%, #d1cfc7 40%, #f2eee2 50%, transparent 50%, transparent 100%)", transform: "translateX(-" + (O - 3) + "px) translateY(-" + (P - 3) + "px) rotate(" + 2 * G + "deg) scaleX(-1)"}) : g(a), T = "0% 100% 0px", U = "rotate(-" + (90 - G) + "deg) translateY(" + Q + "px)", V = "rotate(" + (90 - G) + "deg) translateY(-" + R + "px) translateX(-" + S + "px)") : u && (G > 1 ? b(".turning").css({width: O + "px", height: P + "px", backgroundColor: "#000", background: "-webkit-linear-gradient(-" + (180 - G) + "deg, #fff 10%, #d1cfc7 40%, #f2eee2 50%, transparent 50%, transparent 100%)", transform: "translateX(-" + (O - 2) + "px) rotate(-" + 2 * G + "deg) scaleX(-1)"}) : g(a), T = "0% 0% 0px", U = "rotate(" + (90 - G) + "deg) translateY(-" + Q + "px)", V = "rotate(-" + (90 - G) + "deg) translateY(" + R + "px) translateX(-" + S + "px)"), o.css({zIndex: 100, transformOrigin: T, transform: U}), b(z).parent(".flip-mask").css({zIndex: 99, display: "block"}), b(z).css({zIndex: 1e3}), b(y).css({transformOrigin: T, transform: V}))) : v ? (b(".turning").css({width: (n.width() - a.x) / 2 + "px", height: n.height() + "px", left: a.x + "px", background: "-webkit-linear-gradient(left, #fff 0% , #d1cfc7 15%, #f2eee2 85%, #fff 100%)"}), o.css({transformOrigin: "0% 50% 0px", left: 0, transform: "translateX(-" + (o.width() - a.x) + "px)"}), b(y).css({transformOrigin: "0% 50% 0px", transform: "translateX(" + (o.width() - a.x) + "px)"})) : w && (o.css({zIndex: 100, transformOrigin: "0% 50% 0px", transform: "translateX(" + a.x + "px)"}), b(y).css({transformOrigin: "0% 50% 0px", transform: "translateX(-" + a.x + "px)"}), b(".turning").css({width: n.width() - a.x + "px", height: n.height() + "px", left: -(n.width() - 2 * a.x) + "px", background: "-webkit-linear-gradient(left, #fff 0% , #d1cfc7 15%, #f2eee2 85%, #fff 100%)"}))
  }

  function g(a) {
    b(".turning").css({width: (n.width() - a.x + 6) / 2 + "px", height: n.height() + "px", top: 0, left: a.x + 2 + "px", background: "-webkit-linear-gradient(left, #fff 0% , #d1cfc7 10%, #f2eee2 90%, #fff 100%)", transform: "", border: 0})
  }
  ...
  function h() {
    ...
    var c = b("#report0");
    c.length && c.remove(), E = "feeling", t = !1, u = !1, v = !1, w = !1, x = !0, s = 0, b(".flip-mask").css({transform: "", top: 0, left: 0, zIndex: 0}), b(y).removeClass("z-current").css({transform: "", top: 0, left: 0}), b(z).removeClass("z-active").addClass("z-current").css({transform: ""}), b(".turning").css({width: 0, height: 0, top: 0, left: 0, transform: "", background: "none"}), y = z;
  ...
  function j() {
    "turning" != E && "leaving" != E && (q = {x: 0, y: n.height()}, c(q, "mock"), E = "turning", b(".main-page").css({width: n.width() + "px", height: n.height() + "px"}), r = {x: 0, y: n.height()}, w = !0, C = setInterval(function () {
      r.x++, d(r, "mock"), r.x <= 250 && (clearInterval(C), e(r, "mock"))
    }, 1))
  }

  function k() {
    "turning" != E && "leaving" != E && (q = {x: n.width(), y: n.height()}, c(q, "mock"), E = "turning", b(".main-page").css({width: n.width() + "px", height: n.height() + "px"}), r = {x: n.width(), y: n.height()}, B && p ? v = !0 : t = !0, Y = setInterval(function () {
  ...
  a.turnBook = function (a) {
    W = a, W.obj.property.autoFlip && W.obj.property.autoFlipTime && (X = W.obj.property.autoFlipTime, l()), A = W.obj.property.triggerLoop, b('<div class="turning"></div>').appendTo(".nr"), b(".main-page").css({width: b(".nr").width() + "px", height: b(".nr").height() + "px"}), n.on(B ? "touchstart" : "mousedown", function (a) {
...
var eqxiu = function () {
  function a(a) {
    if ("10" != f._scrollMode) {
      ...
      d || (d = a);
      var h = $(f.$currentPage).find(".m-img").attr("id").substring(4), i = $(f.$currentPage).siblings(".main-page").find("#page" + d);
      if (!i)return;
  ...
  var f, g, h, i, j, k, l, m, n, o = $(window), p = !1, q = !1, r = mobilecheck(), s = tabletCheck(), t = 0, u = 0, v = 0, w = 0, x = !1, y = !1, z = !0, A = 500, B = .4, C = function (a, b, c, e) {
    function l(a, b, c) {
    ...
    function T() {
      if (Math.abs(w) > Math.abs(v) && completeEffect($(f.$currentPage))) {
        if (w > 0) {
          if (f._isDisableFlipPrevPage)return;
          (y || z) && (y = !1, z = !1, f.$activePage && (f.$activePage.classList.remove("z-active"), f.$activePage.classList.remove("z-move")), V(!0), f.$activePage && f.$activePage.classList.contains("main-page") && ($(f.$activePage).addClass("z-active z-move"), $(f.$activePage).css({zIndex: 0, opacity: 1})), $(f.$currentPage).css({opacity: 1}), $(f.$activePage).css({zIndex: 0, opacity: 1}), n($(f.$activePage), "transform", "translateY(0)"), n($(f.$currentPage), "transform-origin", "0% 0% 0px"))
        } else if (0 > w) {
          if (f._isDisableFlipNextPage)return;
          (!y || z) && (y = !0, z = !1, f.$activePage && (f.$activePage.classList.remove("z-active"), f.$activePage.classList.remove("z-move")), V(!1), f.$activePage && f.$activePage.classList.contains("main-page") && (f.$activePage.classList.add("z-active"), f.$activePage.classList.add("z-move"), $(f.$activePage).css({zIndex: 0, opacity: 1})), $(f.$currentPage).css({opacity: 1}), $(f.$activePage).css({zIndex: 0, opacity: 1}), n($(f.$activePage), "transform", "translateY(0)"), n($(f.$currentPage), "transform-origin", "0% 0% 0px"))
        }
    ...
    function U() {
      Math.abs(w) > Math.abs(v) && Math.abs(w) > 20 ? (n($(f.$currentPage), "transform", "translateY(" + k + "px) rotate(" + Math.abs(w) / k * 90 + "deg)"), $(f.$currentPage).css({opacity: .5}), $(document).trigger("flipend")) : (l(f.$currentPage.style, "Transition", "none"), l(f.$activePage.style, "Transition", "none"), f._isDisableFlipPage = !1, C())
    }
    ...
    function Y(a, b, c, d) {
      if ("1" == d || "3" == d)n($(f.$currentPage), "transform", "scale(0.2)"); else if ("5" == d || "11" == d) {
        var e = b > 0 ? "" : "-";
    ...
    !function () {
      ...
      var d = $("#report0"), g = $(f.$activePage).find(".m-img").attr("id").substring(4);
  ...
  return{pageScroll: a, nextPage: c, prePage: b, app: C, pauseAutoFlip: e}
}();
!function (a, b) {
  function c(a, c) {
    if (!b("#report0").length) {
  ...
  function appendActivityPage(a, b) {
    a.obj.property.activityPageId && (activityPagePromise = $.ajax({type: "GET", url: PREFIX_S1_URL + "eqs/pageTpl/" + a.obj.property.activityPageId, xhrFields: {withCredentials: !0}, crossDomain: !0, success: function (a) {
      a.obj && b.push(a.obj)
    }}))
  }
  ...
  function eqCustomBottomLabel(a, b) {
    ad = 2, $.ajax({type: "GET", url: PREFIX_S1_URL + "eqs/pageTpl/" + a.obj.property.bottomLabel.id, xhrFields: {withCredentials: !0}, crossDomain: !0, success: function (c) {
  ...
  function parsePage(pages, data) {
    for (var pageInfo = [], init = !1, audioObj = {bgAudio: data.obj.bgAudio}, pageNum = 1; pageNum <= pages.length; pageNum++)if ($('<section class="main-page"><div class="m-img" id="page' + pageNum + '"></div></section>').appendTo(".nr"), 10 == pageMode && ($("#page" + pageNum).parent(".main-page").wrap('<div class="flip-mask" id="flip' + pageNum + '"></div>'), $(".main-page").css({width: $(".nr").width() + "px", height: $(".nr").height() + "px"})), pages.length > 1 && (0 == pageMode || 1 == pageMode || 2 == pageMode || 6 == pageMode || 7 == pageMode || 8 == pageMode || 11 == pageMode || 12 == pageMode ? $('<section class="u-arrow-bottom"><img src="' + CLIENT_CDN + 'view/images/btn01_arrow.png" /></section>').appendTo("#page" + pageNum) : (3 == pageMode || 4 == pageMode || 5 == pageMode || 9 == pageMode || 10 == pageMode) && $('<section class="u-arrow-right"><img src="' + CLIENT_CDN + 'view/images/btn01_arrow_right.png" /></section>').appendTo("#page" + pageNum)), 1 == pageNum && ($(".loading").hide(), $(".main-page").eq(0).addClass("z-current"), pages[pageNum - 1].elements && pages[pageNum - 1].elements.length && $.each(pages[pageNum - 1].elements, function (a, b) {
    ...
    }(pageNum) : pages[pageNum - 1].properties.finger ? (pageInfo.push({num: pageNum, finger: pages[pageNum - 1].properties.finger}), init || (init = !0, $.getScript(CLIENT_CDN + "view/js/lock_effect.js", function (a, b, c) {
      ...
      if (isMobile || $("img").on("dragstart", function (a) {
        ...
        param && (pvUrl += "?1=1", pvUrl += /\?.*/.test(param) ? "&" + param.substring(1) : /\&.*/.test(param) ? param : "&" + param), pvUrl += (/\?/.test(pvUrl) ? "&" : "?") + "ad=" + ad, $.ajax({type: "GET", url: pvUrl, xhrFields: {withCredentials: !0}, crossDomain: !0})
      }
    }
  ...
  function bindShare(data) {
    if (mobilecheck() || tabletCheck())isWeixin() && configWeixin(data); else if (100 != data.obj.bizType)with (window._bd_share_config = {common: {bdSnsKey: {}, bdText: data.obj.name, bdSign: "on", bdDesc: data.obj.name, bdUrl: PREFIX_HOST + "/s/" + sceneId, bdStyle: "0", bdSize: "32"}, share: {}}, document)0[(getElementsByTagName("head")[0] || body).appendChild(createElement("script")).src = "http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion=" + ~(-new Date / 36e5)]
  }
