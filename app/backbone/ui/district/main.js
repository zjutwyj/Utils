 ...
 */
app.addModule('District', 'ui/district/controllers/District.js');
app.addTemplate('template/district_list', function(require, exports, module){
  module.exports = require('ui/district/views/district_list.html');
});
app.addTemplate('template/district_item', function(require, exports, module){
  module.exports = require('ui/district/views/district_item.html');
});
app.addTemplate('template/district_view', function(require, exports, module){
  module.exports = require('ui/district/views/district_view.html');
});