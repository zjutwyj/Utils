/**
 * @description AnimatePanel
 * @class AnimatePanel
 * @author yongjin<zjut_wyj@163.com> 2015/6/12
 */
define('AnimatePanel', ['template/animate_panel'], function (require, exports, module) {
  var AnimatePanel, template;

  template = require('template/animate_panel');

  AnimatePanel = BaseView.extend({
    events: {
