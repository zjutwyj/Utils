/**
 * @description LotteryDrawJquery
 * @class LotteryDrawJquery
 * @author yongjin<zjut_wyj@163.com> 2015/3/25
 */
define('LotteryDrawJquery', ['Canvas', 'template/common_lottery_draw', 'rotate'], function (require, exports, module) {
  var LotteryDrawJquery, Canvas, template, rotate;

  Canvas = require('Canvas');
  template = require('template/common_lottery_draw');
  rotate = require('rotate');

  LotteryDrawJquery = function () {

  }

  LotteryDrawJquery.prototype = {
    initialize: function () {
  ...
  module.exports = LotteryDrawJquery;
});