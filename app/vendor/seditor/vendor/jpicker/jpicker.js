                  ...
                  container.css( // positions must be set and display set to absolute before source code injection or IE will size the container to fit the window
                    {
                      ...
                      top: win.position.y == 'top' ? (popup.offset().top) + 'px' :
                           win.position.y == 'center' ? (popup.offset().top - 50) + 'px' :
      ...
      color:
        {
          ...
          active: new Color({ hex: 'transparent' }), /* acceptable values are any declared $.jPicker.Color object or string HEX value (e.g. #ffc000) WITH OR WITHOUT the "#" prefix */
