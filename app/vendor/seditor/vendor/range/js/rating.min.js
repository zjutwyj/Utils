(function($) {
	...
	$.fn.slidy = function(options) {
		var defaultOptions = {
			...
			defaultValue : null,
			theme : {
				image : 'vendor/range/themes/blue.png',
				width : 168,
				height : 36
			}
		}
		...
		this
				.each(function() {
					var slider = $(this);
					$('<div class="value"></div><div class="cursor"></div>')
							.appendTo(slider);
					slider.css({
						position : 'relative',
						overflow : 'hidden',
					...
					$('.value', slider).css(
							{
								...
								'background-position' : '0px -'
										+ defaultOptions.theme.height + 'px',
								left : '-95px',
								'background-image' : "url('" + cacheImage.src
										+ "')",
								'height' : defaultOptions.theme.height + 'px',
					...
					var aSlider = {
						...
						init : function(options) {
							...
							if (options.defaultValue == null) {
								this.setInitValue(options.minval / this.interval);
							} else {
								this.setInitValue(options.defaultValue
										/ this.interval);
							}
							$(document)
									.mouseup(
											function() {
												...
												if (!aSlider.isCalled) {
													aSlider.finishedCallback
															&& aSlider.finishedCallback
																	.call(
																			this,
																			aSlider.currentValue
																					* aSlider.interval);
						...
						handleCursor : function(e) {
							if (aSlider.clickedOnCursor) {
								...
								var valueLevelAtCurosor = Math.floor(pos[0]
										* this.numberOfValue / this.width);
								this.currentValue = valueLevelAtCurosor <= 1 ? 1
										: valueLevelAtCurosor;
								this.currentValue = this.currentValue >= this.numberOfValue ? this.numberOfValue
										: this.currentValue;
						...
						setValue : function(value) {
							...
							aSlider.moveCallback
									&& aSlider.moveCallback.call(this,
											aSlider.currentValue
													* aSlider.interval);
							var newLeftPos = aSlider.width
									- Math.floor(value * this.scale);
