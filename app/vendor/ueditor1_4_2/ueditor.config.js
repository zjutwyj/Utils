...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义   scrawl:涂鸦   insertvideo：视频  music:音乐 attachment：附件 snapscreen：截屏 help:帮助
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'jhwimage','jhwflash','qq','qrcode', 'emotion',  'map', 'gmap', 'insertframe','insertcode', 'webapp', 'pagebreak', 'template', 'background', '|',
